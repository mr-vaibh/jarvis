...
#=====================  J.A.R.V.I.S. Version  ============================================
    if 'jarvis --v' in query or 'jv --v' in query:
        print ('''                  ################################################
                  ...
                  #                                              #
                  ################################################''')
        speak('Hi, I\'m JARVIS, version one point zero point three')
...
#=========================      Greet      ============================================
    ...
    elif 'good' in query or 'like' in query or 'great' in query or 'bravo' in query or 'wow' in query or 'thank' in query or 'thanx' in query or 'thnx' in query:
        if 'bye' not in query:
            glad_rnd = random.choice(glad)
            pr(glad_rnd)
            speak(glad_rnd)
    elif 'friend' in query or 'pal' in query or 'buddy' in query or 'love' in query:
        friend_rnd = random.choice(friend)
        pr(friend_rnd)
        speak(friend_rnd)
